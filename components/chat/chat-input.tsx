...
export const ChatInput = ({
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        try{
            ...
            // to reset what is in the chat input box
            form.reset();
            router.refresh();
                            ...
                            <FormControl>
                                <div className="relative p-4 pb-5">
                                    <button 
                                        ...
                                        className="absolute top-7 left-8 h-[24px] w-[24px] bg-zinc500 
                                    ...
                                    <Input
                                        ...
                                        border-0 focu-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
